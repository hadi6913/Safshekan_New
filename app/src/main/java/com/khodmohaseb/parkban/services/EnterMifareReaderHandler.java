...
public class EnterMifareReaderHandler extends Service implements Runnable {
    ...
    public interface Callbacks {
        void enterMifareResult(boolean result);
        ...
        try {
            ...
            if (scan_card > 0) {
                ...
                if (SNLen == 4) {
                    ...
                    int result1 =  piccManager.m1_writeBlock(16,16,block16);
                    int result2 =  piccManager.m1_writeBlock(17,16,block17);
                    int result3 =  piccManager.m1_writeBlock(18,16,block18);


                    Log.d(TAG, "write block 16  >>>  "+result1);
                    Log.d(TAG, "write block 17  >>>  "+result2);
